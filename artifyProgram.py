...
def artify():
    ...
    for song in non_artified_playlist['items']:
        ...
        song_uris_and_color_codes[song_dominant_color_code] = song_uri
...
def create_spotify_oauth():
    return SpotifyOAuth(client_id = 'bdb9cf762e8142da8fe0775983c3b564',
                        client_secret = 'c8d0292c324f4f43ba3eba9637ac04ac',
